...
toolbarbutton = toolbar:CreateButton("Wall Brush", "Wall Brush", "brush.png")
...
brushDragBar, elevationFrame, elevationHelpFrame, elevationCloseEvent = RbxGui.CreatePluginFrame("Wall Terrain Brush",UDim2.new(0,151,0,160),UDim2.new(0,0,0,0),false,g)
brushDragBar.Visible = false
